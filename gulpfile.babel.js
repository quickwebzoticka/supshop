...
export const development = series(cleanFiles, fonts, parallel(pugToHTML, styles, scripts, images, favs),
	parallel(watchCode, server));

export const prod = series(cleanFiles, fonts, serverConfig, pugToHTML, styles, scripts, images, favs);
